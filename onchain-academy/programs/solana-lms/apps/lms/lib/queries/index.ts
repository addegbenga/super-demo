...
export const courseQueries = {
  ...
  search: (language: any, query: string = "", filters: any = {}) =>
    queryOptions({
      queryKey: queryKeys.courses.search(language, query, filters),
      queryFn: () => queryBuilder.searchCoursesQuery(language, query, filters),
      staleTime: staleTime,
    }),
};
